...
const titleBanner = await readFile(new URL("./title-banner.png", import.meta.url));
const titleBannerDataUrl = `data:image/png;base64,${titleBanner.toString("base64")}`;
...
const standalone = html
  ...
  .replaceAll("./title-banner.png", titleBannerDataUrl)
  .replace(
